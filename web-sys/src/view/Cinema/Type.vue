...
import { addCategoryApi, listApi, editCategoryApi, deleteCategoryApi } from
    '../../api/cinemacategory/index'
import { type Category } from '../../api/cinemacategory/CinemaCategoryModel'
